...
exports.default = scaledStrokeWidth;
...
const PROPS_MAX = {
  style: {
    strokeWidth: STROKE_MAX.toFixed(1)
  }
};
const PROPS_MIN = {
  style: {
    strokeWidth: STROKE_MIN.toFixed(1)
  }
};
...
function scaledStrokeWidth(graphState) {
  ...
  if (k > THRESHOLD_MIN) {
    ...
    props = cache[strokeWidth] || (cache[strokeWidth] = {
      style: {
        strokeWidth
      }
    });
